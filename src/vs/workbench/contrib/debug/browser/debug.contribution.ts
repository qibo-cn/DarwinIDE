...
function registerDebugMenu(): void {
	...
	MenuRegistry.appendMenuItem(MenuId.MenubarDebugMenu, {
		...
		command: {
			...
			title: nls.localize({ key: 'miCompiling', comment: ['&& denotes a mnemonic'] },
				"&&Compile Darwinlang")
		},
		order: 1,
		when: CONTEXT_DEBUGGERS_AVAILABLE
	...
	MenuRegistry.appendMenuItem(MenuId.MenubarDebugMenu, {
		...
		command: {
			...
			title: nls.localize({ key: 'miSimulating', comment: ['&& denotes a mnemonic'] },
